...
public class EncryptUtil {
    ...
    public static class Encryptor {
        public static final String UTF8_ENCODING_FORMAT = "ISO8859_1";

        public static final String DES3_ALGORITHM = "DESede";

        public static final String DES3_ALGORITHM_PAD = "DESede/CBC/PKCS5Padding";

        private static final Class<?> CLASS_NAME = EncryptUtil.class;

        /**
         * Initialises the cipher based on the service and the mode
         * 
         * @param p_ServiceName
         *            the name of the service
         * @param p_CipherMode
         *            the mode i.e. encryption/decryption
         * @return The initialized cipher
         * @throws Des3DecryptionException
        ...
        /**
         * @param p_encryptedString
         *            the encrypted string
         * @return the decrpted string
         * @throws Des3DecryptionException
         *             if the descryption failed
         */
        public static String decrypt(String key, String iv, String p_encryptedString) throws RequestNotFoundException{
         ...
         *             if the descryption failed
         */
        public static String encrypt(String key, String iv, String p_StringToEncrypt) throws RequestNotFoundException{

            final String METHOD_NAME = "encrypt";

            String m_encryptedString = null;
            if (p_StringToEncrypt == null) { return null; }
            try {

                // encode
                Cipher m_cipher = init(key, iv, Cipher.ENCRYPT_MODE);
                byte[] encrypted = m_cipher.doFinal(p_StringToEncrypt.getBytes());
